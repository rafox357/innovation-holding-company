          ...
          <CardContent>
            ...
            <Button asChild>
              <Link href="/blueprint-platform/components">
                View Components <ArrowRight className="ml-2 h-4 w-4" aria-hidden="true" />
              </Link>
            </Button>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            <Button asChild>
              <Link href="/blueprint-platform/interactions">
                Explore Interactions <ArrowRight className="ml-2 h-4 w-4" aria-hidden="true" />
              </Link>
            </Button>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            <Button asChild>
              <Link href="/blueprint-platform/benefits">
                See Benefits <ArrowRight className="ml-2 h-4 w-4" aria-hidden="true" />
              </Link>
            </Button>
          </CardContent>
        </Card>
